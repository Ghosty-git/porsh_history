                ...
                child: Text.rich(
                  TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                        text:
                            ", and it marks the second version of the 992. The company claims the Cabriolet will be just as good to drive as the coupe. Removing the roof the car is supposed to have little impact on its chassis stiffness and curvy road prowess.",
                        style: TextStyle(
                          color: Colors.white,
                          fontFamily: "Iowan Old Style",
                          fontSize: 16.sp,
